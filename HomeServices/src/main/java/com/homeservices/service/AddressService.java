...
public interface AddressService {
	...
	public Address addAddress(AddressDto address, HttpServletRequest request, HttpServletResponse response) throws AddressException, UserProfileException;
	
	public Address updateAddress(AddressDto address, HttpServletRequest request, HttpServletResponse response) throws AddressException, UserProfileException;
	...
	public String deleteAddress(Long id,HttpServletRequest request,HttpServletResponse response) throws AddressException, UserProfileException;
